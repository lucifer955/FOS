...
<?php 
    ...
    if (isset($_POST['changeCashierPassword'])) {
    ...
    //check if usename and password has been entered
      ...
      if(empty($errors)){
        ...
        $query =  "UPDATE cashier SET cashierPassword = '{$password_hash}' WHERE cashierId=$cashierId";
...
<!-- 					  <h5 class="card-header">Search</h5> -->
					<div class="card-body">
						 <form action="cashierChangePassword.php" method="POST">
					        <div class="form-row">
					      ...
					      <br>
					        <button type="submit" class="btn btn-primary" name="changeCashierPassword">Update</button>
					    </form>   
				  	</div>
				</div>
			</div>
