    ...
    //check if usename and password has been entered
      ...
      if(empty($errors)){
        ...
        $query = "SELECT * FROM cashier
                    WHERE cashierEmail = '{$email}'
                    -- hashed password should be included
                    AND cashierPassword = '{$hashed_password}'
                    LIMIT 1";
        ...
        if ($result_set) {
          ...
          if(mysqli_num_rows($result_set) == 1){
            ...
            $_SESSION['cashier_id'] = $us['cashierId'];
            $_SESSION['cashier_name'] = $us['cashierName'];
       ...
       <div class="container-fluid">
        <div class="row d-flex justify-content-center">
          <div class="col-12 col-sm-12 col-md-6 col-lg-6">
            <h3 class="text-center ">Food Ordering System | Cashier Login</h3>
          </div>

          <div class="col-12 col-sm-12 col-md-4 col-lg-4 ">
            <form class="form-container" method="post" action="cashier_login.php">

              <?php 

                if (isset($errors) && !empty($errors)) {
                  echo '<p class = "errorCashier">Invalid Username / Password</P>';
                } 
