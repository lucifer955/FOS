		...
		<div class="row">
		  	<div class="col-12 col-sm-12 col-md sideBarMenu" >
			    <div class="nav text-center flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link linkAll active" id="v-pills-profile-tab" id="linkAll" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="cateAll()">All</a>
<?php  
	...
	if($cats){
		...
		while ($cat = mysqli_fetch_assoc($cats)) {
			...
			echo "
			    ...
			    <input type='hidden' id='cats$x' name='filter$x' value={$cat['categoryName']}> 
			";
		}
	}
