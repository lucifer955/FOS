...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM users WHERE mobilenumber='$mobilenumber' OR email='$email' LIMIT 1";
  ...
  if (count($errors) == 0) {
    ...
    $query = "INSERT INTO users (firstname, lastname, email, mobilenumber, password) 
