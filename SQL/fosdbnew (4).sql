...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2020 at 06:27 AM
...
INSERT INTO `checkout` (`checkoutD`, `itemName`, `itemPrice`, `foodQuantity`, `foodMenuId`, `cartID`) VALUES
(21, 'Corn n Cheese', '350', 2, 7, 1),
(22, 'Corn n Olive', '370', 1, 8, 2),
(23, 'Corn n Olive', '370', 2, 8, 1),
(24, 'Corn n Cheese', '350', 2, 7, 2),
(25, 'Corn n Cheese', '350', 3, 7, 1),
(26, 'Corn n Olive', '370', 2, 8, 2),
(27, 'Devilled Chicken', '450', 1, 10, 3);
...
(16, 711231234, 'Hasara', 'Nadun', '2020-04-09 08:21:01', 'h@z.com', '81dc9bdb52d04dc20036dbd8313ed055');
...
(41, 'Delivery', 's', 'y', 's', 's', 'd', 15, '2020-06-10 04:22:40', 1070, 0),
(42, 'Delivery', 's', 'y', 's', 's', 'd', 15, '2020-06-10 04:23:31', 1440, 0),
(43, 'Delivery', 's', 'sfd', 's', 's', 'd', 14, '2020-06-10 04:25:37', 2240, 0);
...
--
ALTER TABLE `cartorder`
  MODIFY `cartHistoryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=559;
...
--
ALTER TABLE `checkout`
  MODIFY `checkoutD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
